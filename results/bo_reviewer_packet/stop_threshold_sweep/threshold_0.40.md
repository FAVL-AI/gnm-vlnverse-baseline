...
Checkpoint : `gnm_base_stop_0.40.pt`
...
| **Mean Navigation Error** | **5.99 m** | Average final distance to goal across all episodes |
...
| 3 | `kujiale_0118_kujiale_0118_25_3` | kujiale_0118 | 3.63 m | 3.53 m | 3.53 m | 0.57 m | 4 | no | no |
...
| 6 | `kujiale_0203_kujiale_0203_15_3` | kujiale_0203 | 5.56 m | 5.20 m | 5.20 m | 0.81 m | 6 | no | no |
...
| 15 | `kujiale_0271_kujiale_0271_7_3` | kujiale_0271 | 2.18 m | 2.35 m | 2.18 m | 0.26 m | 3 | **YES** | YES |
...
python3 scripts/gnm/explain_eval_success_rate.py \
    --checkpoint /tmp/gnm_base_stop_0.40.pt \
