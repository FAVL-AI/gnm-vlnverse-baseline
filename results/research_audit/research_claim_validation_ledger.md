...
| `tracka_all_methods_per_episode_provenance` | **BLOCKED** | Per-episode provenance exists for all Track A stop-policy methods. | results/research_audit/tracka_all_methods_per_episode_metric_provenance.csv<br>results/research_audit/tracka_all_methods_metric_provenance_report.json | Must include baseline_gnm, hand_tuned_waypoint_gate, logistic_stop_head, temporal_neural_stop_head, and geometry_aware_oracle. |
